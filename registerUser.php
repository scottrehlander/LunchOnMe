...
<body>
	<div data-role="page" id="page" data-theme="<?php echo($dataTheme); ?>">
		<div data-role="header" data-theme="<?php echo($headerDataTheme); ?>">
			<?php
				// If groupId exists, pass that through to index
				$extraParams = "";
				if(isset($_GET['groupId']) && $_GET['groupId'] != "")
					$extraParams = "?groupId=" . $_GET['groupId'];
				 
				echo('<a href="index.php' . $extraParams . '" data-icon="back" class="ui-btn-left">Back</a>');
			?>			
		...
		<div data-role="content" >
			...
			<?php
				// If groupId is set, tell the user that they will join the group after registering
				if(isset($_GET['groupId']) && $_GET['groupId'] > -1)
				{
					// Accept the registration
					echo("<center>Please register to join your friend's group.</center>");		
				}
			?>
