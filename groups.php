...
<body>
	<div data-role="page" id="page" data-theme="<?php echo($dataTheme); ?>">
		...
		<div data-role="content" >
			<ul id="groupsOverviewPageList" data-role="listview" data-inset="true" data-filter="true" data-divider-theme="<?php echo($dividerDataTheme); ?>">
			...
			<ul id="groupsOverviewPageList" data-role="listview" data-inset="true" data-divider-theme="<?php echo($dividerDataTheme); ?>">
